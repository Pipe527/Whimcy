				...
				<div class="product-top">
					...
					<ul> 
						...
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								<li><a href="#">Exito</a></li> 
								<li><a href="#">McDonals</a></li>
								<li><a href="#">RestauranteX</a></li> 
								<li><a href="#">Otro</a></li> 
							</ul> 
						</li>
					</ul> 
				...
				<div class="products-row">
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Coca Cola</a></h5> 
								<h6><del>$2500</del> $2250</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Coca Cola"/> 
									<input type="hidden" name="amount" value="2250" /> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Gourmet </a></h5> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Refrigerios</a></h5> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Raisin Bran</a></h5> 
								<h6><del>$42</del> $40</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Frutos secos</a></h5> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Nescafe Café</a></h5> 
								<h6><del>$12</del> $10</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Botana</a></h5> 
								<h6><del>$25000</del> $22500</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Botana"/> 
									<input type="hidden" name="amount" value="22500" /> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form> 
							</div>
						</div> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Coctel de jabalí </a></h5> 
								<h6><del>$47500</del> $46000</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Coctel de jabalí"/> 
									<input type="hidden" name="amount" value="46000"/> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form>
							</div>
						</div>
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Coctel Margarita</a></h5> 
								<h6><del>$30000</del> $27000</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Coctel Margarita" /> 
									<input type="hidden" name="amount" value="27000" /> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form> 
							</div>
						</div> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Halloumi Fries </a></h5> 
								<h6><del>$15700</del> $14130</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="Halloumi Fries"/> 
									<input type="hidden" name="amount" value="14130"/> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form>
							</div>
						</div>
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Picada</a></h5> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">McFlurry Oreo</a></h5> 
								<h6><del>$12000</del> $11500</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
									<input type="hidden" name="w3ls_item" value="McFlurry Oreo"/> 
									<input type="hidden" name="amount" value="11500"/> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form>
							</div>
						</div>
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Helado</a></h5> 
								<h6><del>$9000</del> $8100</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Helado"/> 
									<input type="hidden" name="amount" value="8100" /> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form> 
							</div>
						</div> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Frijoles MC </a></h5> 
					...
					<div class="col-md-3 product-grids"> 
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Chorote Paisa</a></h5> 
								<h6><del>$27.900</del> $22320</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart" />
									<input type="hidden" name="add" value="1" /> 
									<input type="hidden" name="w3ls_item" value="Chorote Paisa" /> 
									<input type="hidden" name="amount" value="22320" /> 
									<button type="submit" class="w3ls-cart pw3ls-cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Añadir carrito</button>
								</form> 
							</div>
						</div> 
					...
					<div class="col-md-3 product-grids">
						<div class="agile-products">
							...
							<div class="agile-product-text">              
								<h5 class="Rtext"><a href="single.html">Hamburguesa</a></h5> 
								<h6><del>$6000</del> $4800</h6> 
								<form action="#" method="post">
									<input type="hidden" name="cmd" value="_cart"/>
									<input type="hidden" name="add" value="1"/> 
